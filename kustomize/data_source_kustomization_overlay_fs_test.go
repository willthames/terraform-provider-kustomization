...
output "check1" {
	value = data.kustomization_overlay.test1.manifests["~G_~V_Namespace|~X|test-overlay1"]
}

output "check2" {
	value = data.kustomization_overlay.test2.manifests["~G_~V_Namespace|~X|test-overlay2"]
}
