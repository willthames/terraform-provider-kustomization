...
output "check" {
	value = data.kustomization_overlay.test.manifests["~G_~V_Namespace|~X|test-basic"]
}
`
}
...
output "check" {
	value = data.kustomization_overlay.test.manifests["~G_~V_ConfigMap|~X|from-component-6ct58987ht"]
}
`
}
...
output "check_cm1" {
	value = data.kustomization_overlay.test.manifests["~G_~V_ConfigMap|~X|test-configmap1"]
}

output "check_cm2" {
	value = data.kustomization_overlay.test.manifests["~G_~V_ConfigMap|~X|test-configmap2-5tgmgc9cmf"]
}
`
}
...
output "check" {
	value = data.kustomization_overlay.test.manifests["~G_~V_Namespace|~X|test-overlay-namespace"]
}
...
output "check" {
	value = data.kustomization_overlay.test.manifests["~G_~V_Service|test-basic|test-test-test"]
}
...
output "check" {
	value = data.kustomization_overlay.test.manifests["apps_~V_Deployment|test-transformer-config|test"]
}
`
}
...
output "check" {
	value = data.kustomization_overlay.test.manifests["~G_~V_ConfigMap|~X|testcm-6ct58987ht"]
}
`
}
...
output "check_configmap" {
	value = data.kustomization_overlay.test.manifests["~G_~V_ConfigMap|~X|test-configmap"]
}

output "check_secret" {
	value = data.kustomization_overlay.test.manifests["~G_~V_Secret|~X|test-secret"]
}
`
}
...
output "check" {
	value = data.kustomization_overlay.test.manifests["apps_~V_Deployment|test-basic|test"]
}
`
}
...
output "check_ingress" {
	value = data.kustomization_overlay.test.manifests["networking.k8s.io_~V_Ingress|test-basic|test"]
}
`
}
...
output "check_cm1" {
	value = data.kustomization_overlay.test.manifests["~G_~V_Secret|~X|test-secret1"]
}

output "check_cm2" {
	value = data.kustomization_overlay.test.manifests["~G_~V_Secret|~X|test-secret2-h55cfd6gfg"]
}
`
}
...
output "check_dep" {
	value = module.test.kustomization.manifests["apps_~V_Deployment|test-module|tp-test-ts"]
}

output "check_cm" {
	value = module.test.kustomization.manifests["~G_~V_ConfigMap|test-module|tp-ocm-ts"]
}

output "check_s" {
	value = module.test.kustomization.manifests["~G_~V_Secret|test-module|tp-os-ts-8226t8dd99"]
}
